...
objectDirectory = "binary/object"
copyDirectory = "binary/copy"
...
executableName = "Pestle"

compileAll = args.all

if args.windows:
    compilerFlags += "-std=gnu++14"
elif systemName == "Darwin":
    compilerFlags += "-stdlib=libc++ -std=gnu++14"
else:
    compilerFlags += "-std=gnu++14"
...
if returnCode == 0:
    ...
    if returnCode == 0:
        ...
        if args.run != None:
            print("    > Running...")
            if systemName == "Windows":
                os.system(executableName+" "+"".join(args.run))
            else:
                os.system("./"+executableName+" "+"".join(args.run))
    else:
